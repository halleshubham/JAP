...
def getImages(summary):
    ...
    for i in range(0,len(summary[0]["titles"])):
        ...
        try:
            ...
            output = open(creds["images_folder_path"]+str(count)+".jpg","wb")
            output.write(resource.read())
            output.close()
        except Exception as e:
            print (e)
            ...
            # Open the url image, set stream to True, this will return the stream content.
                ...
                if r.status_code == 200:
                    ...
                    with open(creds["images_folder_path"]+filename,'wb') as f:
...
creds_path="../issue_params.json"
with open(creds_path, encoding='utf-8-sig')  as f:
        creds=json.load(f)

summary = get_summary_data(creds["summaryfile"])
a = getImages(summary)
